...
import { getShowsFromLibrary, makeGettersForShowsOfLibrary } from '../../../app/utils';
    ...
    return <ApiLoading getters={{
    ...
    }}>
        {
            ({ values }) => {
                ...
                makeGettersForShowsOfLibrary(getters, library)
                return <ApiLoading getters={getters}>{({ values }) => {
                    const shows = getShowsFromLibrary(values, library)
